/*
SELECT * FROM ODIN_ITEM_UPDATE_RECORDS WHERE INV_ITEM_ID = 'ST5525' ORDER BY INPUT_DATE DESC
ALTER TABLE [dbo].[ODIN_ITEM_UPDATE_RECORDS] ADD [WARRANTY] [varchar](max) NULL
ALTER TABLE [dbo].[ODIN_ITEM_UPDATE_RECORDS] ADD [WARRANTY_CHECK] VARCHAR(1) 
ALTER TABLE [dbo].[ODIN_ITEM_UPDATE_RECORDS] ADD [DTC_PRICE] [varchar](18) NULL
ALTER TABLE [dbo].[ODIN_ITEM_UPDATE_RECORDS] ADD [WEBSITE_PRICE] [varchar](18) NULL
ALTER TABLE [dbo].[ODIN_ITEM_UPDATE_RECORDS] ADD [SELL_ON_GUITAR_CENTER] [varchar](1) NULL
ALTER TABLE [dbo].[ODIN_ITEM_UPDATE_RECORDS] ADD [SELL_ON_ECOM] [varchar](1) NULL
ALTER TABLE [dbo].[ODIN_ITEM_UPDATE_RECORDS] ADD [SUBJECT_KEYWORDS] [varchar](500) NULL
ALTER TABLE [ODIN_ITEM_UPDATE_RECORDS] ADD [A_PARENT_ASIN] VARCHAR(10)
ALTER TABLE [dbo].[ODIN_ITEM_UPDATE_RECORDS] ADD [A_ITEM_TYPE_KEYWORDS] [varchar](500) NULL
ALTER TABLE [dbo].[ODIN_ITEM_UPDATE_RECORDS] ADD [SELL_ON_TRS] [varchar](1) NULL
ALTER TABLE [dbo].[ODIN_ITEM_UPDATE_RECORDS] ADD [SELL_ON_HOUZZ] [varchar](1) NULL
