/*
SELECT * FROM ODIN_ITEM_UPDATE_RECORDS WHERE INV_ITEM_ID = 'RP14200' ORDER BY INPUT_DATE DESC
ALTER TABLE [dbo].[ODIN_ITEM_UPDATE_RECORDS] ADD [ORIENTATION] [varchar](254) NULL
ALTER TABLE [dbo].[ODIN_ITEM_UPDATE_RECORDS] ADD [EXCLUSIVE] [varchar](15) NULL
ALTER TABLE [dbo].[ODIN_ITEM_UPDATE_RECORDS] ADD [GENRE_1] [varchar](254) NULL
ALTER TABLE [dbo].[ODIN_ITEM_UPDATE_RECORDS] ADD [GENRE_2] [varchar](254) NULL
ALTER TABLE [dbo].[ODIN_ITEM_UPDATE_RECORDS] ADD [GENRE_3] [varchar](254) NULL

ALTER TABLE ODIN_ITEM_UPDATE_RECORDS ADD CONSTRAINT df_Genre1  DEFAULT '' FOR GENRE_1
ALTER TABLE ODIN_ITEM_UPDATE_RECORDS ADD CONSTRAINT df_Genre2  DEFAULT '' FOR GENRE_2
ALTER TABLE ODIN_ITEM_UPDATE_RECORDS ADD CONSTRAINT df_Genre3  DEFAULT '' FOR GENRE_3
