...
sp_help ODIN_ITEM_TEMPLATES
 ALTER TABLE [ODIN_ITEM_TEMPLATES] ADD [DTC_PRICE] VARCHAR(12)
 ALTER TABLE [ODIN_ITEM_TEMPLATES] ADD [WARRANTY] VARCHAR(MAX)
 ...
 ALTER TABLE [ODIN_ITEM_TEMPLATES] ADD [ECOMMERCE_ITEM_TYPE_KEYWORDS] VARCHAR(500)
*/
SET ANSI_NULLS ON
GO
