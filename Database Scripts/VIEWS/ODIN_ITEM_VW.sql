...
CREATE VIEW ODIN_ITEM_VW AS
	...
	SELECT DISTINCT
           ...
           dbo.Odin_RetrieveSellOnFlag(MASTER_ITEM_TBL.INV_ITEM_ID, 'SHOP TRENDS') AS SELL_ON_TRS,
		   ...
		   PRODUCT_ATTRIBUTES_ORIENTATION.ATTRIBUTE_VALUE AS ORIENTATION,
	...
	FROM PS_MASTER_ITEM_TBL MASTER_ITEM_TBL
		...
		LEFT JOIN PS_PRODUCT_ATTRIBUTES PRODUCT_ATTRIBUTES_ORIENTATION
			...
			AND PRODUCT_ATTRIBUTES_ORIENTATION.ATTRIBUTE_TYPE = 'ORIENTATION'
